...
public class DefaultNotificationManager implements NotificationManager {
  ...
  public Multimap<String, NotificationChannel> findSubscribedRecipientsForDispatcher(NotificationDispatcher dispatcher, String projectUuid) {
    checkArgument(projectUuid != null, "ProjectUUID is mandatory");
    ...
    for (NotificationChannel channel : notificationChannels) {
      ...
      List<String> subscribedUsers = dbClient.propertiesDao().findUsersForNotification(dispatcherKey, channelKey, projectUuid);
